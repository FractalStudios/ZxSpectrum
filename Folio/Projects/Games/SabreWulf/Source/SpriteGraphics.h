...
enum SPRITE_ID
{
    ...
    SPRITE_SABRE_MAN_GAME_OVER_LEFT     = IDB_BITMAP_SABRE_MAN_GAME_OVER_LEFT,          // 24 x 21.
    SPRITE_SABRE_MAN_GAME_OVER_RIGHT    = IDB_BITMAP_SABRE_MAN_GAME_OVER_RIGHT,         // 24 x 21.

    SPRITE_WOLF_WALKING_LEFT_1          = IDB_BITMAP_WOLF_WALKING_LEFT_1,              
    SPRITE_WOLF_WALKING_LEFT_2          = IDB_BITMAP_WOLF_WALKING_LEFT_2,              
    SPRITE_WOLF_WALKING_LEFT_3          = IDB_BITMAP_WOLF_WALKING_LEFT_3,              
    SPRITE_WOLF_WALKING_RIGHT_1         = IDB_BITMAP_WOLF_WALKING_RIGHT_1,             
    SPRITE_WOLF_WALKING_RIGHT_2         = IDB_BITMAP_WOLF_WALKING_RIGHT_2,             
    SPRITE_WOLF_WALKING_RIGHT_3         = IDB_BITMAP_WOLF_WALKING_RIGHT_3,             

    SPRITE_WOLF_JUMPING_LEFT_1          = IDB_BITMAP_WOLF_JUMPING_LEFT_1,              
    SPRITE_WOLF_JUMPING_LEFT_2          = IDB_BITMAP_WOLF_JUMPING_LEFT_2,              
    SPRITE_WOLF_JUMPING_RIGHT_1         = IDB_BITMAP_WOLF_JUMPING_RIGHT_1,             
    SPRITE_WOLF_JUMPING_RIGHT_2         = IDB_BITMAP_WOLF_JUMPING_RIGHT_2,             

    SPRITE_RHINOCEROS_RUNNING_LEFT_1    = IDB_BITMAP_RHINOCEROS_RUNNING_LEFT_1,        
    SPRITE_RHINOCEROS_RUNNING_LEFT_2    = IDB_BITMAP_RHINOCEROS_RUNNING_LEFT_2,        
    SPRITE_RHINOCEROS_RUNNING_RIGHT_1   = IDB_BITMAP_RHINOCEROS_RUNNING_RIGHT_1,       
    SPRITE_RHINOCEROS_RUNNING_RIGHT_2   = IDB_BITMAP_RHINOCEROS_RUNNING_RIGHT_2,       

    SPRITE_HIPPOPOTAMUS_RUNNING_LEFT_1  = IDB_BITMAP_HIPPOPOTAMUS_RUNNING_LEFT_1,      
    SPRITE_HIPPOPOTAMUS_RUNNING_LEFT_2  = IDB_BITMAP_HIPPOPOTAMUS_RUNNING_LEFT_2,      
    SPRITE_HIPPOPOTAMUS_RUNNING_RIGHT_1 = IDB_BITMAP_HIPPOPOTAMUS_RUNNING_RIGHT_1,     
    SPRITE_HIPPOPOTAMUS_RUNNING_RIGHT_2 = IDB_BITMAP_HIPPOPOTAMUS_RUNNING_RIGHT_2,     
    SPRITE_HIPPOPOTAMUS_SLEEPING        = IDB_BITMAP_HIPPOPOTAMUS_SLEEPING,            

    SPRITE_WARTHOG_RUNNING_LEFT_1       = IDB_BITMAP_WARTHOG_RUNNING_LEFT_1,              
    SPRITE_WARTHOG_RUNNING_LEFT_2       = IDB_BITMAP_WARTHOG_RUNNING_LEFT_2,              
    SPRITE_WARTHOG_RUNNING_RIGHT_1      = IDB_BITMAP_WARTHOG_RUNNING_RIGHT_1,             
    ...
    SPRITE_FIRE_1                       = IDB_BITMAP_FIRE_1,                           
    SPRITE_FIRE_2                       = IDB_BITMAP_FIRE_2,                           
    SPRITE_FIRE_3                       = IDB_BITMAP_FIRE_3,                           
    SPRITE_FIRE_4                       = IDB_BITMAP_FIRE_4,                           
