...
struct StaticSpriteAttributes
{
    ...
    ZxSpectrum::COLOUR  m_staticSpriteColour;   // The colour of the static sprite.
...
typedef Folio::Core::Game::SpriteGraphicsAttributes<STATIC_SPRITE_ID, SPRITE_ID> StaticSpriteGraphicAttributes;

// Static sprite graphic attributes table.
static  const   StaticSpriteGraphicAttributes   g_staticSpriteGraphicAttributesTable [] =
{
...
:   m_staticSpriteId(STATIC_SPRITE_UNDEFINED),
    ...
    m_screenYTop(ZxSpectrum::UNDEFINED),
    m_staticSpriteColour(ZxSpectrum::UNDEFINED),
...
FolioStatus StaticSprite::Create (FolioHandle               dcHandle, 
                                  ...
                                  ZxSpectrum::COLOUR        staticSpriteColour,
                                  UInt32                    staticSpriteFlags)
{
    ...
    FolioStatus status = QuerySpriteGraphics<STATIC_SPRITE_ID, StaticSpriteGraphicAttributes> (dcHandle,
                                                                                               staticSpriteId,
                                                                                               spriteGraphicsMap,
                                                                                               staticSpriteColour,
                                                                                               sizeof (g_staticSpriteGraphicAttributesTable) / sizeof (StaticSpriteGraphicAttributes),
                                                                                               g_staticSpriteGraphicAttributesTable,
    ...
    if (status == ERROR_SUCCESS)
    {
        ...
        Int32   initialScreenYTop = ZxSpectrum::CalculateScreenYTop (initialScreenYBottom, 
        ...
        status = Folio::Core::Game::AStaticSprite::Create (dcHandle,
                                                           ...
                                                           ZxSpectrum::MapInkColour (staticSpriteColour),
...
ZxSpectrum::COLOUR  StaticSprite::GetStaticSpriteColour () const
{
...
FolioStatus ScatterStaticSprites (StaticSpritesList &staticSpritesList)
{
         ...
         ++itr)
    {
        ...
        case STATIC_SPRITE_KEY:
            ...
            {
            case ZxSpectrum::BRIGHT | ZxSpectrum::RED:
                staticSprite->SetScreenNumber (GetRedKeyLocation ());
                break;

            case ZxSpectrum::BRIGHT | ZxSpectrum::GREEN:
                staticSprite->SetScreenNumber (GetGreenKeyLocation ());
                break;

            case ZxSpectrum::BRIGHT | ZxSpectrum::CYAN:
                staticSprite->SetScreenNumber (GetCyanKeyLocation ());
                break;

            case ZxSpectrum::BRIGHT | ZxSpectrum::YELLOW:
