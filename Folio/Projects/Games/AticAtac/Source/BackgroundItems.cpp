...
{
    return (m_backgroundItemGraphic ? m_screenXLeft : ZxSpectrum::UNDEFINED);
} // Endproc.
...
{
    return (m_backgroundItemGraphic ? m_screenXLeft + m_backgroundItemGraphic->GetGraphicWidth () - 1 : ZxSpectrum::UNDEFINED);
} // Endproc.
...
{
    Int32   screenWidth = ZxSpectrum::UNDEFINED;   
...
{
    Int32   screenHeight = ZxSpectrum::UNDEFINED;   
...
Folio::Core::Game::CollisionGrid::ScreenExit::ORIENTATION   BackgroundItem::GetDoorOrientation () const
{
    ...
    case Folio::Core::Game::ResourceGraphic::ORIENTATION_TOP:
        return (((m_backgroundItemId == BACKGROUND_ITEM_OPEN_TRAP_DOOR)      || 
                ...
                ? Folio::Core::Game::CollisionGrid::ScreenExit::FLOOR 
                : Folio::Core::Game::CollisionGrid::ScreenExit::TOP);

    case Folio::Core::Game::ResourceGraphic::ORIENTATION_BOTTOM:
        return (Folio::Core::Game::CollisionGrid::ScreenExit::BOTTOM);
    
    case Folio::Core::Game::ResourceGraphic::ORIENTATION_LEFT:
        return (Folio::Core::Game::CollisionGrid::ScreenExit::LEFT);
    
    case Folio::Core::Game::ResourceGraphic::ORIENTATION_RIGHT:
        return (Folio::Core::Game::CollisionGrid::ScreenExit::RIGHT);
    
    default:
        return (Folio::Core::Game::CollisionGrid::ScreenExit::NONE);
    } // Endswitch.
