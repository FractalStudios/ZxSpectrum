...
private:
    static  const   UInt32  WEAPON_SPRITE_SPEED = 4;    // Weapon sprite speed.
    ...
    void    SetWeaponSpriteTerminatedSoundSample (WEAPON_SPRITE_ID weaponSpriteId);
    void    SetWeaponSpriteReboundSoundSample (WEAPON_SPRITE_ID weaponSpriteId);
